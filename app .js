...
angular.module("constants", []).constant("appName", "Join").constant("playStoreUrl", "").constant("itunesUrl", "").constant("socialShareMessage", "").constant("buildEnv", "prod").constant("facebookAppId", "340785822781848").constant("facebookAppName", "Cloneder").constant("parseAppId", "hcTsndhxxAO2HFPt3WXSk3G3UfpxXtRKrQwy6TQC").constant("parseJavascriptKey", "3JrYZhYUDgesfl8jBMZhJTi6c5CkxqswtR13oiAV").constant("parseSubDomain", "cloneder").constant("parseClientKey", "knKQIUl70iAxbe3pX53eMpdw3mdoNNbmEH1bq2aF").constant("linkedInId", "75zt0sfhmxae7g").constant("linkedInSecret", "pA1hcchX4XgIvMBV");
